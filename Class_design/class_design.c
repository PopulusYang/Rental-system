...
int main()
{
    ...
    extendAgency("1234abc", "1234abc", ag_p1, ag_p2, ag_tail);//创建临时中介账户，调试用
    ag_tail = ag_tail->next;
    ag_p2 = ag_tail;
    assert(ag_tail);
    strcpy(ag_tail->Name, "123");
    strcpy(ag_tail->phone_n, "12345678901");
    ...
    extendCustomer("1234abc", "1234abc", cu_p1, cu_p2, cu_tail);//创建临时管理员账户，调试用
    cu_tail = cu_tail->next;
    cu_p2 = cu_tail;
    strcpy(cu_tail->Name, "123");
    strcpy(cu_tail->phone_n, "12342345345");
